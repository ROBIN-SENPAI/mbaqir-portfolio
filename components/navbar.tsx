    ...
    <>
      <motion.header
        ...
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
          isScrolled ? "bg-background/80 backdrop-blur-xl border-b border-white/[0.06]" : ""
        }`}
        style={isScrolled ? { boxShadow: "0 1px 30px rgba(0,0,0,0.3)" } : {}}
      >
        <nav className="flex items-center justify-between px-6 py-4 my-0 md:px-12 md:py-5">
          ...
          >
            <img src="/badge.svg" alt="Logo" className="w-6 h-6" />
            <span className="font-sans text-sm tracking-wider text-white/80">M.Baqir Firas</span>
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <span className="font-mono text-xs tracking-wider text-muted-foreground">OPEN TO COLLABORATION</span>
          </div>
